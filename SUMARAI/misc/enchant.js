 ...
 * 
 * Modified by Mithat: enchant.WebAudioSound.play() places
 * this.src.disconnect(this.connectTarget); in a try/catch block to
 * prevent uncaught exception from stopping the whole show on (some?)
 * systems.
 */
